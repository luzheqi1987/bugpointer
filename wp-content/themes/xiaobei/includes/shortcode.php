...
<?php }
function xiaobei_shortcode_page(){
  add_theme_page("xiaobei短代码提示","xiaobei短代码提示",'edit_themes','xiaobei_shortcode_page','xiaobei_Shortpage'); 
}
add_action('admin_menu','xiaobei_shortcode_page');
