...
<div class="jiange2"></div>
	<h3 id="comments" class="mtitle"><?php the_title(); ?>：目前有<?php comments_number('', '1 条留言', '% 条留言' );?></h3>
	<div class="b2"></div>
	...
	<div id="comment-author-info">
      ...
      <p><?php include(TEMPLATEPATH . '/includes/smiley.php'); ?></p>
		...
		<p>
			...
			<?php // <a title="查看如何申请一个自己的Gravatar全球通用头像" target="_blank" href="http://www.cmhello.com/gravatar.html"> +评论没头像？去弄个呗！</a>
			 ?>
