...
<!-- You can start editing here. -->
	<?php if ( have_comments() ) : ?>
			<div class="comments_title">
				<h3 id="comments"><?php comments_number(__('No 留言', 'yotheme'), __('1 留言', 'yotheme'), __('% 留言'), 'yotheme'); ?></h3>
			</div>
	...
	?>
		<?php if ('open' == $post->comment_status) : ?>
			...
			<p class="nocontent"><?php _e('暂时还没有留言.', 'yotheme'); ?></p>
		...
		<div id="respond">
			...
			<?php else : ?>
				...
				<?php endif; ?>
						...
						<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php echo attribute_escape(__('提交评论', 'yotheme')); ?>" /> <?php _e ('[Ctrl + Enter]', 'yotheme'); ?> <?php comment_id_fields(); ?></p>
